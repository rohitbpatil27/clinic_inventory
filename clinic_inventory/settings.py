"""
Django settings for clinic_inventory project.
...
SECRET_KEY = 'django-insecure-ct81cyb2(x9a$3n%h7p@pi6p-af12t-w&#s$8!_fn-muos96md'
...
MIDDLEWARE = [
    ...
    'inventory.middleware.LogUserActionsMiddleware',
]

ROOT_URLCONF = 'clinic_inventory.urls'
...
CSRF_TRUSTED_ORIGINS = ['https://clinic-inventory.onrender.com/']
